      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-bg-main/80 backdrop-blur-lg border-bottom border-black/5 py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-700">
            ...
            <a href="#contact" className="px-5 py-2 bg-charcoal text-white rounded-full hover:bg-slate-800 transition-colors">Contact Us</a>
          </div>
        </div>
      </nav>
              ...
              <form className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-bg-main border border-charcoal/10 rounded-lg px-4 py-3 text-charcoal focus:outline-none focus:border-charcoal/30 transition-colors" placeholder="John Doe" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-500">Email</label>
                    <input type="email" className="w-full bg-bg-main border border-charcoal/10 rounded-lg px-4 py-3 text-charcoal focus:outline-none focus:border-charcoal/30 transition-colors" placeholder="john@example.com" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-500">Message</label>
                  <textarea rows={4} className="w-full bg-bg-main border border-charcoal/10 rounded-lg px-4 py-3 text-charcoal focus:outline-none focus:border-charcoal/30 transition-colors" placeholder="How can we collaborate?"></textarea>
                </div>
                <button className="w-full py-4 bg-charcoal text-white font-semibold rounded-lg hover:bg-slate-800 transition-all">
                  Send Message
                </button>
              </form>
            </div>
        ...
        {activeModal && (
          ...
          >
            <motion.div
              ...
              className="bg-bg-main w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
            >
              <div className="p-6 border-b border-charcoal/10 flex justify-between items-center bg-white sticky top-0 z-10">
                <h2 className="text-xl font-bold text-charcoal">
                  {activeModal === 'privacy' ? 'Privacy Policy' : 'Terms of Service'}
                </h2>
                <button 
                  onClick={() => setActiveModal(null)}
                  className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-charcoal/5 transition-colors text-slate-500 hover:text-charcoal"
                >
